...
# -*- coding: utf-8 -*-
"""
Created on Fri Aug 25 12:07:02 2017
...
class NeuralNetwork():
    def __init__(self): 
        ...
        # We model a single neuron, with 3 input connections and output connections
    ...
    def train(self, training_set_inputs, training_set_outputs, number_of_training_iterations):
        for iteration in xrange(number_of_training_iterations):
            # pass the trianing set through our neural net
...
if __name__ == '__main__': 
    ...
    #Do it 10,0000 times and make small adjustments each time. 
